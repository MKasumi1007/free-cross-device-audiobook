...
| 私密 Firestore Rules | 27 个 Emulator 测试通过；必要修复已真实部署 |
...
维护者请从 [项目交接文档](docs/PROJECT_HANDOVER.md) 开始；完整历史证据、失败项和未完成项见 [验收矩阵](docs/ACCEPTANCE.md)，实时状态和小段断点设计见 [0.4.0 生成状态与断点续作](docs/2026-07-30_生成状态与断点续作.md)，此前真机过程见 [2026-07-18 实测报告](docs/2026-07-18_本轮开发与iPhone实测报告.md)。

## 普通用户安装

1. 从 [Releases](https://github.com/MKasumi1007/free-cross-device-audiobook/releases/tag/v0.5.3) 下载 `MilanReader-Installer-0.5.3.zip`。
